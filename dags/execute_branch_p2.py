...
default_args = {
    ...
    'email': ['az.salma.tech@gmail.com'],
    'email_on_failure': False,
    'email_on_retry': False,
    'retries': 1
}

DATASETS_PATH = '/mnt/d/airflow_exercises/datasets/insurance.csv'

OUTPUT_PATH = '/mnt/d/airflow_exercises/output/{0}.csv'
